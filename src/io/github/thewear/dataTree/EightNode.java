...
public class EightNode extends Node {

	/**
	 * processNode() compares the cloud cover (80% threshold);
	 * 
	 * cloud cover > 80% --> WeatherEnums.DEFAULT (other)
	 * 
	 * cloud cover <= 80% --> WeatherEnums.SUNNYWEATHER
	 * 
	 * @param nodeNumber
	...
	public Object processNode(int nodeNumber, Object[] dataToCompare,
		...
		if (cloudCover > (Integer) dataToCompareWith[0]) {
			...
			WeatherEnums weatherType = WeatherEnums.SUNNYWEATHER;
			return weatherType;
		}
	}
}