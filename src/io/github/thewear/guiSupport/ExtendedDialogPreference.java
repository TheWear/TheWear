...
/**
 * A base class for {@link Preference} objects that are dialog-based. These
...
public abstract class ExtendedDialogPreference extends Preference implements
	...
	/**
	 * List of activity destroy listeners. // from PreferenceManager
	 */
	private List<OnActivityDestroyListener> mActivityDestroyListeners;

	public ExtendedDialogPreference(Context context, AttributeSet attrs,
			int defStyle) {
		super(context, attrs, defStyle);

		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.ExtendedDialogPreference, defStyle, 0);
		mDialogTitle = a
				.getString(R.styleable.ExtendedDialogPreference_dialogTitle);
		...
		mDialogMessage = a
				.getString(R.styleable.ExtendedDialogPreference_dialogMessage);
		mDialogIcon = a
				.getDrawable(R.styleable.ExtendedDialogPreference_dialogIcon);
		mPositiveButtonText = a
				.getString(R.styleable.ExtendedDialogPreference_positiveButtonText);
		mNeutralButtonText = a
				.getString(R.styleable.ExtendedDialogPreference_neutralButtonText);
		mNegativeButtonText = a
				.getString(R.styleable.ExtendedDialogPreference_negativeButtonText);
		mDialogLayoutResId = a.getResourceId(
				R.styleable.ExtendedDialogPreference_dialogLayout,
				mDialogLayoutResId);
		a.recycle();
	...
	/**
	 * Sets the text of the neutral button of the dialog. This will be shown on
	 * subsequent dialogs.
	 * 
	...
	protected void showDialog(Bundle state) {
		...
		mBuilder = new AlertDialog.Builder(context).setTitle(mDialogTitle)
				...
				.setNeutralButton(mNeutralButtonText, this)
	...
	private void registerOnActivityDestroyListener(
			OnActivityDestroyListener listener) {
		synchronized (getPreferenceManager()) {
